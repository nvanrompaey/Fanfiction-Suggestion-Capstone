...
class MassStyles():
    ...
    def make_array(self):
        ...
        for row in range(self.quantity):
            ...
            #Stop word frequency
            arrayrow.append(SF.token_frequency("and",self.size)) #15
            arrayrow.append(SF.token_frequency("but",self.size)) #16
            arrayrow.append(SF.token_frequency("however",self.size)) #17
            arrayrow.append(SF.token_frequency("said",self.size)) #18
            arrayrow.append(SF.token_frequency("while",self.size)) #19
            arrayrow.append(SF.token_frequency("as",self.size)) #20
            arrayrow.append(SF.token_frequency("ing",self.size)) #21
            arrayrow.append(SF.token_frequency("though",self.size)) #22
            arrayrow.append(SF.token_frequency("with",self.size)) #23
            arrayrow.append(SF.token_frequency("cause",self.size)) #24
            arrayrow.append(SF.token_frequency("to",self.size)) #25
            arrayrow.append(SF.token_frequency("this",self.size)) #26
            arrayrow.append(SF.token_frequency("that",self.size)) #27
            arrayrow.append(SF.token_frequency("why",self.size)) #28
            arrayrow.append(SF.token_frequency("how",self.size)) #29
            arrayrow.append(SF.token_frequency("if",self.size)) #30
            arrayrow.append(SF.token_frequency("then",self.size)) #31
